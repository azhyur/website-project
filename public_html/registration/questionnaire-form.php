...
?>
	...
	<div class="container">
      		...
      		<form class="form-signin" style="max-width: 800px" action="questionnaire_user.php" method="post">
      			...
      			<h1 class="form-signin-heading" align="center" style="font-size: 48px;">User Questionnaire</h1>

			<div class="row">
			    <div class="col-lg-8">

				<p style="font-size: 20px;">1. Are you male or female?</p>
			...
			<div class="row">
				...
				<p style="font-size: 20px;">2. Do you use a hearing aid or a cochlear implant?</p>
			...
			<div class="row">
				...
				<p style="font-size: 20px;">3. How long have you had a problem with your hearing?</p>
			...
			<div class="row">
				...
				<p style="font-size: 20px;">4. Have you ever participated in auditory training before?</p>
